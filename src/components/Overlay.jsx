...
const Overlay = () => {
  ...
  useEffect(() => {
    const openPanel = (image, annotation) => {
      setPanelImage(`/${image}`);
  ...
  return (
    <>
        ...
        {showFloatingPanel && (
          <>
            ...
            <motion.div
              ...
              } bg-[#C6C1AE] backdrop-blur-md shadow-2xl z-50 flex flex-col`}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="text-[rgba(255,254,247,0.8)] text-base leading-relaxed text-center">
      ...
      <AnimatePresence>
        {showModalPanel && (
          <>
            {/* Overlay de fondo con blur - por encima del floating panel */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            {/* Modal Panel centrado - 80% de la pantalla */}
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
              animate={{ opacity: 1, scale: 1 }}
